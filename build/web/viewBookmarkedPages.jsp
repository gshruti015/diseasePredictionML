...
<!--				<ul>
        ...
        <% String a;
        ArrayList<urlDetail>  cl=urlc.geturlDetail();
         ...
         for(int i=0;i<cl.size();i++){
            ...
            out.println("</td>");       
            out.println("<td>");  %>     
            <a href="<%=cl.get(i).getUrl1()%>"><%=cl.get(i).getUrl1()%>   
        <%    out.println("</td>");       
            out.println("</tr>");        
