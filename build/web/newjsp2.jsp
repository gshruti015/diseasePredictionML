		...
		<div class="body">
			<div class="section">
				<div class="article">
					...
					<p>
					  <h1>Your Page has been added to Favourites !</h1>
        
        
        <jsp:useBean id="shr" class="beans.urlDetail"/>
        <jsp:setProperty name="shr" property="url1"  param="url1"/>
          <jsp:getProperty name="shr" property="url1"/>
