...
public class Apriori extends Observable {
    ...
    String use2="";
      ...
      //nameOfTextFile="C:/Users/Gateway/Desktop/java files/output.txt";

    PrintWriter pw = new PrintWriter(new FileOutputStream("C:/Users/Gateway/Documents/NetBeansProjects/svm/src/java/outfile.txt"));
    ...
    private void foundFrequentItemSet(int[] itemset, int support) {
    	if (usedAsLibrary) {
            ...
            //use="The output is "+ Arrays.toString(itemset) + "  ("+ ((support / (double) numTransactions))+" "+support+")";
            use=","+ Arrays.toString(itemset);
    ...
    {        
        // setting transafile
/////yeha pe make changes for date thingggg 
